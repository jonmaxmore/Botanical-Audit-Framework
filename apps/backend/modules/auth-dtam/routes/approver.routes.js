 ...
 */
router.get('/dashboard/stats', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
 ...
 */
router.get('/applications', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
 ...
 */
router.get('/applications/:id', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { DTAMApplication } = req.container;
 ...
 */
router.post('/applications/:id/verify-payment', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/applications/:id/assign', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { DTAMApplication } = req.container;
 ...
 * Approve application
 */
router.post('/applications/:id/approve', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * Reject application
 */
router.post('/applications/:id/reject', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { comments } = req.body;
    const { DTAMApplication } = req.container;
 ...
 */
router.post('/applications/:id/send-back', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/applications/:id/issue-certificate', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { DTAMApplication } = req.container;
 ...
 */
router.get('/applications/pending/count', authenticateJWT, requireRole(['APPROVER', 'ADMIN']), async (req, res) => {
  try {
    const { DTAMApplication } = req.container;
