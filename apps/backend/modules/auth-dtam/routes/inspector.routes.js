 ...
 */
router.get('/dashboard/stats', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
 ...
 */
router.get('/applications', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const inspectorId = req.user.id;
 ...
 */
router.get('/applications/:id', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { DTAMApplication } = req.container;
 ...
 * Schedule inspection
 */
router.post('/applications/:id/schedule', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 * Start inspection
 */
router.post('/applications/:id/start', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
    const { DTAMApplication } = req.container;
 ...
 * Complete inspection
 */
router.post('/applications/:id/complete', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/applications/:id/evidence', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/applications/pending/count', authenticateJWT, requireRole(['INSPECTOR', 'ADMIN']), async (req, res) => {
  try {
    const inspectorId = req.user.id;
    const { DTAMApplication } = req.container;
