...
aiConfigSchema.methods.updatePerformance = function(wasCorrect, wasFalsePositive, wasFalseNegative) {
  ...
  this.performance.accuracy = total > 0
    ? (this.performance.correctPredictions / total * 100)
    : 0;
