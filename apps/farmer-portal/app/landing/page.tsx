    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              ระบบรับรอง
              <br />
              <span className="text-green-600">GACP ดิจิทัล</span>
              <br />
              สำหรับกัญชาและพืชสมุนไพร
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              ยื่นขอใบรับรอง GACP ออนไลน์ ติดตามสถานะแบบเรียลไทม์ พร้อมระบบ Smart Farming
              ช่วยเพิ่มผลผลิต
            </p>
            <div className="flex space-x-4">
              <Link
                href="/register"
                className="px-8 py-4 bg-green-600 text-white rounded-lg text-lg font-semibold hover:bg-green-700 shadow-lg"
              >
                เริ่มต้นใช้งานฟรี
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <div className="w-14 h-14 bg-green-100 rounded-lg flex items-center justify-center mb-4 text-3xl">
              📋
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <div className="w-14 h-14 bg-blue-100 rounded-lg flex items-center justify-center mb-4 text-3xl">
              🌾
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <div className="w-14 h-14 bg-purple-100 rounded-lg flex items-center justify-center mb-4 text-3xl">
              📱
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200">
            ...
            <div className="text-4xl font-bold text-gray-900 mb-4">
              ฟรี<span className="text-lg font-normal text-gray-600">/30 วัน</span>
            </div>
            <button className="w-full py-3 border-2 border-green-600 text-green-600 rounded-lg font-semibold hover:bg-green-50">
              เริ่มทดลองใช้
            </button>
          </div>
          <div className="bg-green-600 p-8 rounded-xl shadow-2xl transform scale-105">
            ...
            <div className="text-4xl font-bold text-white mb-4">
              30,000฿<span className="text-lg font-normal text-green-100">/ใบรับรอง</span>
            </div>
            <button className="w-full py-3 bg-white text-green-600 rounded-lg font-semibold hover:bg-gray-100">
              เริ่มใช้งาน
            </button>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200">
            ...
            <div className="text-4xl font-bold text-gray-900 mb-4">
              ติดต่อ<span className="text-lg font-normal text-gray-600">/ปี</span>
            </div>
            <button className="w-full py-3 border-2 border-green-600 text-green-600 rounded-lg font-semibold hover:bg-green-50">
              ติดต่อเรา
            </button>
      ...
      <section className="bg-gradient-to-r from-green-600 to-green-700 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/register"
            className="inline-block px-8 py-4 bg-white text-green-600 rounded-lg text-lg font-semibold hover:bg-gray-100 shadow-lg"
          >
            ลงทะเบียนฟรี
          </Link>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="w-8 h-8 bg-green-600 rounded-lg flex items-center justify-center text-xl">
              🌿
            </div>
