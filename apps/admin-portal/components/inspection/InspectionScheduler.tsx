...
export default function InspectionScheduler({ inspectionId, onScheduled }: InspectionSchedulerProps) {
  ...
  return (
    <Box sx={{ maxWidth: 600, mx: 'auto', p: 3 }}>
      <Typography variant="h6" gutterBottom>นัดหมายการตรวจสอบ</Typography>
